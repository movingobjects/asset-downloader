...
/**
 * Joins the segments of a path destined for the JSON — not a disk path, so always `/`.
 * A leading slash on the first segment is load-bearing and survives: "/assets/x.jpg" is
 * resolved against the site root, "assets/x.jpg" against whatever page is asking.
 */
export function joinPath(...segments) {
  const rooted = segments[0]?.startsWith('/');
